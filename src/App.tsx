        ...
        <section className="mb-20">
          ...
          <div className="bg-white/70 backdrop-blur-sm p-8 md:p-12 rounded-[30px] shadow-sm">
            <ul className="space-y-6">
              {[
                { label: "Gruppengröße", text: "Preis gilt für 8 Kinder. Bis zu 12 Kinder sind möglich (ab dem 9. Kind +10,00 € pro Kind). Wenn alle Kinder über 1,35m groß sind oder über 35kg wiegen liegt das Limit strikt bei 8 Kindern." },
